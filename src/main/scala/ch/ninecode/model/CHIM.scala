...
{
    override def sqlType: DataType = ArrayType(StringType, true)

    override def pyUDT: String = "ch.ninecode.cim.ElementUDT"

    override def serialize (obj: Any): Seq[String] =
    {
        obj match
        {
            case s: String  =>
    ...
    override def deserialize (datum: Any): Element =
    {
        ...
        {
            case values: Seq[_] =>
              val ids = values.asInstanceOf[Seq[String]]
              new BasicElement (null, ids(0))
            case values: ArrayList[_] =>
              val ids = values.asInstanceOf[ArrayList[String]].asScala
              new BasicElement (null, ids(0))
        }
    }
